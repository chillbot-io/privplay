...
class EntityType(str, Enum):
    ...
    URL = "URL"
    USERNAME = "USERNAME"
    PASSWORD = "PASSWORD"                 # Authentication credentials
    USER_AGENT = "USER_AGENT"             # Browser/device fingerprint
    
    # Crypto
    CRYPTO_ADDRESS = "CRYPTO_ADDRESS"     # Bitcoin, Ethereum, Litecoin, etc.
    
    # Location
    GPS_COORDINATE = "GPS_COORDINATE"     # Latitude/longitude pairs
